          ...
          <!-- Product Image Start -->
           ...
           <div class="pro-content">
               <div class="pro-info">
                   ...
                   <p><span class="price priceName">{{number_format($product->price, 0, '', '.')}}đ</span><del class="prev-price">$105.50</del></p>
               ...
               <div class="pro-actions">
                   ...
                   <div class="actions-secondary">
                       ...
                       <a href="#" title="WishList" data-product-id="{{ $product->id }}" class="add-to-wishlist"><i  class="lnr lnr-heart"></i> <span >Add to WishList</span></a>
                   </div>
               </div>
           </div>
           <!-- Product Content End -->
